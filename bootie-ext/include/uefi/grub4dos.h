...
#define map_start_sector ((unsigned long long *)(SYSVAR(36)))
#define map_num_sectors ((unsigned long long *)(SYSVAR(37)))
#define query_block_entries (SYSVAR(38))
...
#define devwrite ((unsigned int (*)(unsigned long long sector, unsigned long long sector_len, unsigned long long buf))(SYSFUN(33)))
...
#define rawread ((int (*)(unsigned int, unsigned long long, unsigned int, unsigned long long, unsigned long long, unsigned int))(SYSFUN(68)))
